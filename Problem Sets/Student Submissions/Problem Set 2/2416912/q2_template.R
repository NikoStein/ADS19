...
listOfDeals <- map_df(1:50, function(i) {
  site <- sprintf('https://www.mydealz.de/new?page=%d', i)
  cat(toString(i), ' ')
  brian <- getAdsFromLink(site)
  brian
})
# Aufgabe2
